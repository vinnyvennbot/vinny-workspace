# RELATIONSHIPS.md - Vendor & Partner Relationships

*Track reliability, responsiveness, and confidence scores for all Venn vendors/partners.*

## CONFIDENCE SCORING SYSTEM
- **High (0.8-0.9)**: Proven reliable, responsive, high-quality work → Priority for future events
- **Medium (0.5-0.7)**: Standard service, adequate response time → Standard consideration
- **Low (0.2-0.4)**: Unresponsive, quality issues, missed deadlines → Avoid or replace

---

## HIGH CONFIDENCE VENDORS (0.8-0.9)

### Katie - Presidio Events
- **Contact**: presidio@wedgewoodevents.com
- **Categories**: Venue (Log Cabin, Golf Clubhouse, Officers' Club, other Presidio spaces)
- **Confidence**: 0.9
- **History**:
  - Responded promptly to Log Cabin inquiry (Feb 20)
  - Sent proposal options (Feb 23, 9:41 AM)
  - Manages multiple Presidio venues - single point of contact advantage
  - Professional, organized communication
- **Notes**: PRIORITY vendor for SF outdoor/historic venues. Strong existing relationship.

### Summer - Let's Party (Mechanical Bull)
- **Contact**: summer@letspartyproductions.com
- **Category**: Entertainment (mechanical bull, party games)
- **Confidence**: 0.85
- **History**:
  - Quick response to bull inquiry (Feb 5)
  - Competitive pricing ($1,299 for 3 hours)
  - Professional quote with full details
- **Notes**: Reliable for Western/country themed events.

### Laura Drake Chambers - Palace Theater SF
- **Contact**: laura.drake@thepalacetheatersf.com
- **Category**: Entertainment venue, production support
- **Confidence**: 0.8
- **History**:
  - Scheduled call for Murder Mystery Yacht (Feb 20)
  - Responded to inquiry (Feb 23, 9:08 AM)
  - Professional communication, organized
- **Notes**: Good for large-scale productions (400+ guests). Follow up needed after missed call incident.
...
- **Confidence**: 0.7
- **History**:
  - Confirmed venue for EVT-002 (March 1)
  - Responded to inquiry (Feb 23, 9:09 AM)
  - 17/20 spots sold for event
- **Notes**: Good for intimate gatherings (20-40 guests). Wine cellar ambiance.

### Patricia Gums - The Chapel
- **Contact**: thechapelsf--patricia-gums-@discussions.tripleseat.com
- **Category**: Venue (event space, nightlife)
- **Confidence**: 0.65
- **History**:
  - Responded to Nostalgia Night inquiry (Feb 23, 10:02 AM)
...
- **Confidence**: 0.6
- **History**:
  - Responded to Gatsby inquiry (Feb 23, 10:21 AM) - ARCHIVED EVENT
  - Response time good
- **Notes**: DO NOT engage for archived events. Potentially good for future large events.

### Presidio Golf Clubhouse (Tracey Lyons)
- **Contact**: TBD (via Katie/Presidio Events)
- **Category**: Venue
- **Confidence**: 0.65
- **History**:
  - Quote awaited for EVT-001
...
- **Category**: Venue
- **Confidence**: 0.3
- **History**: Contacted Feb 5, no response after 18 days
- **Notes**: Consider alternative for future events.
...
### Analisa Svehaug - Betaworks
- **Contact**: analisa@betaworks.com
- **Category**: Accelerator/Investment
- **Confidence**: N/A (not vendor)
- **History**:
  - Interview request for Betaworks Camp (Feb 23, 9:32 AM)
  - Active application in progress
- **Notes**: Strategic partnership opportunity, not event vendor.

---

## USAGE NOTES

**Before selecting vendors for new events:**
1. Check High Confidence list first - proven reliable
2. Review Medium Confidence for standard needs
3. Avoid Low Confidence unless no alternatives
4. Update confidence scores after each event based on performance

**After each vendor interaction:**
1. Update contact information if changed
2. Add notes about responsiveness, quality, issues
