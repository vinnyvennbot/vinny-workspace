# EVT-003 Postponement Queue

**Archived:** 2026-02-18
**Send postponements after:** 2026-02-23 (5-day rule)

## Do NOT send postponement (calls already scheduled — Zed handling):
- McCalls SF (Cyrus Pahlavan, CPahlavan@mccallssf.com) — call Mon Feb 23 11 AM
- VEP (Andrew Verducci, andrew@wearevep.com) — call Fri Feb 20 11 AM

## Send postponement Feb 23+ (engaged, no call):
| Vendor | Email | Thread ID | Category |
|--------|-------|-----------|----------|
| Fraiche Catering | chi@fraichecater.com | 19c457dd3af1fc50 | Catering |
| Taste Catering | Melissa@tastecatering.com | 19c6fe4a696caf0f | Catering |
...
## Reminder cron:
Set a cron to fire on 2026-02-23 to send these.
